...
#ifndef PARTITIONED_LOCAL_FIFO_SCHEDULER_H
#define PARTITIONED_LOCAL_FIFO_SCHEDULER_H
...
// (2) pass the pointer to construct PartitionedLocalFIFOScheduler.
class PartitionedLocalFIFOScheduler : public VoltdbSchedulerUtil {
public:
  PartitionedLocalFIFOScheduler(voltdb::Client* client, std::string dbAddr,
  ...
  // Destructor
  ~PartitionedLocalFIFOScheduler() { /* placeholder for now. */
  }
...
#endif  // #ifndef PARTITIONED_LOCAL_FIFO_SCHEDULER_H
